...
import com.example.filmverse.Activities.SearchActivity
import com.example.filmverse.Domain.MovieFavourite
import com.example.filmverse.databinding.ViewholderFavouriteBinding

class SearchListAdapter(private val context: SearchActivity, private val items: MutableList<MovieFavourite>) : RecyclerView.Adapter<SearchListAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ViewholderFavouriteBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(film: MovieFavourite) {
            ...
            binding.movieRating.text = "IMDb: ${film.ratingImdb}" ?: "Kinopoisk: ${film.ratingKp}"
